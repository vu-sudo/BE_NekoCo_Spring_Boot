                                            ...
                                            <tr>
                                                <td align="left" style="padding:0;Margin:0;width:560px">
                                                    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;font-size:0"><img src="https://eetjhzb.stripocdn.email/content/guids/CABINET_e18b62ca1480033ccb888cca7acb830a6f9724d1537c0b870e634f2e7248f13a/images/untitled_design.png" alt="" width="150" class="img-5191" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" class="es-text-2466" style="padding:0;Margin:0"><h1 align="center" class=" es-m-txt-c" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:30px;font-style:normal;font-weight:normal;line-height:43px !important;color:#333333"><strong>​To Reset Your Password</strong><span style="font-size:36px">​</span><span class="es-text-mobile-size-36">​</span></h1></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0"><p align="center" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">You need to use the pass code below to reset your account's password</p><p align="center" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Here is your:</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0"><h3 align="center" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:40px !important;color:#3d85c6" class=" es-m-txt-c"><strong>${passCode}</strong></h3></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0;padding-right:40px;padding-left:40px"><p align="center" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Reset password code is valid for 10 minutes and is randomly generated. Thank you for using MeowCo.&nbsp;</p></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="padding:0;Margin:0"><p align="center" class=" es-m-txt-c" style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:28px !important;letter-spacing:0;color:#333333;font-size:14px"><em>Contact us at</em>: Fanpage | Email | Website</p></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
